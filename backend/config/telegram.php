...
// use Telegram\Bot\Commands\RegisterCommand;
return [
    /*
    |--------------------------------------------------------------------------
    | Your Telegram Bots
    ...
    */
    'bots' => [
        'mybot' => [
            'token' => env('TELEGRAM_BOT_TOKEN', '6636575835:AAHh2X5plj7oBfRNLwzyTsnmuLUuyxAgSSM'),
            'certificate_path' => env('TELEGRAM_CERTIFICATE_PATH', 'home/rplnekat/ssl/certs/www_laragram_rplnekat_com_cfb5c_2ff5d_1736207364_3f599398aaa6e288fc0623ff7707e7e0.crt'),
            'webhook_url' => env('TELEGRAM_WEBHOOK_URL', 'https://laragram.rplnekat.com/bot/webhook'),
            /*
